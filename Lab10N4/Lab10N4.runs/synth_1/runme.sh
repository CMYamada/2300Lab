...
HD_PWD='D:/Lab10N4/Lab10N4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CounterCircuit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CounterCircuit.tcl
