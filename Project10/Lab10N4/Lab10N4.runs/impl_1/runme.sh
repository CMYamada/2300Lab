...
HD_PWD='D:/Lab10N4/Lab10N4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CounterCircuit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CounterCircuit.tcl -notrace
