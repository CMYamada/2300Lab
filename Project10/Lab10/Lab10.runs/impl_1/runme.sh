...
HD_PWD='D:/Lab10/Lab10.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log UpCounter4Bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source UpCounter4Bit.tcl -notrace
