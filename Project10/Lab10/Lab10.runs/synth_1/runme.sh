...
HD_PWD='D:/Lab10/Lab10.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log UpCounter4Bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source UpCounter4Bit.tcl
