...
HD_PWD='D:/Lab11/DigitalClock/DigitalClock.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DigitalClock.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DigitalClock.tcl -notrace
